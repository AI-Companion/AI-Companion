...
MODELS_DIR = os.path.join(ROOT_DIR, "marabou/train_module/trained_models")
PLOTS_DIR = os.path.join(ROOT_DIR, "marabou/train_module/perf")
EMBEDDINGS_DIR = os.path.join(ROOT_DIR, "marabou/train_module/saved_embeddings")
DATA_DIR = os.path.join(ROOT_DIR, "marabou/train_module/data")
SCRIPT_DIR = os.path.join(ROOT_DIR, "marabou/train_module/bash_scripts")

SA_CONFIG_FILE = os.path.join(ROOT_DIR, "marabou/train_module/config/config_sentiment_analysis.json")
NER_CONFIG_FILE = os.path.join(ROOT_DIR, "marabou/train_module/config/config_named_entity_recognition.json")
IMDB_DATASET_SCRIPT_FILE = os.path.join(SCRIPT_DIR, "load_imdb_dataset.sh")
FASHION_DATASET_SCRIPT_FILE = os.path.join(SCRIPT_DIR, "load_fashion_dataset.sh")
NER_DATASET_SCRIPT_FILE = os.path.join(SCRIPT_DIR, "load_ner_dataset.sh")
