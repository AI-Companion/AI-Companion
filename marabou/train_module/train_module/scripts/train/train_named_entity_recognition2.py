...
from train_module.utils import KaggleDataset, EMBEDDINGS_DIR, NER_CONFIG_FILE, ROOT_DIR, PLOTS_DIR, MODELS_DIR
...
def preprocess_data(X: List, y: List, data_processor: NERPreprocessor)\
    ...
    X_train, n_tokens_train, y_train = data_processor.preprocess(X_train, y_train)
    X_test, n_tokens_test, y_test = data_processor.preprocess(X_test, y_test)
